                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- <form action="" method="post" enctype="multipart/form-data" class="form-horizontal"> -->
                            <div class="form-group row">
                                <strong class="col-md-3 " >Nombre <span  v-if="!sicompleto" class="error">(*)</span></strong>
                                <div class="col-md-9">
                                    <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Descripcion" v-model="nombre" v-on:focus="selectAll" >
                                    <span  v-if="!sicompleto" class="error">Debe Ingresar el Nombre de la Cargo</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <strong class="col-md-3">Nivel de Gerarquia:</strong>
                                <div class="col-md-9">
                                    <select v-model="nivelselected" class="form-control" >
                                        <option v-for="nivel in arrayNivel" :key="nivel" :value="nivel" v-text="nivel"></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <strong class="col-md-3 " >Descripcion </strong>
                                <div class="col-md-9">
                                    <input type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre del Cargo" v-model="descripcion" v-on:focus="selectAll" >
                                </div>
                            </div>
                        <!-- </form> -->
                    </div>
            ...
            eliminarCargo(idcargo){
                ...
                if (result.isConfirmed) {
                     axios.put('/cargo/desactivar',{
                        ...
                        me.listarCargo(me.pagination.current_page);

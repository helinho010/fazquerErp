...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('alm__ingreso_producto', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('id_tipoentrada')->after('id_prod_producto')->default(40)->comment("Identificador unico, que relaciona la tabla de alm__ingreso_producto y la tabla prod__tipo_entradas");
